...
public class Battlecard implements Comparable<Battlecard> {
    ...
    public boolean isDamageInRange(double lo, double hi) {
        return this.damage >= lo && this.damage <= hi;
    }

    public boolean isSwagInRange(double lo, double hi) {
        return this.swag >= lo && this.swag <= hi;
    }

    public boolean isDamageBelow(double hi) {
        return this.damage <= hi;
    }
